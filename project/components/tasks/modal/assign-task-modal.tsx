...
export function AssignTaskModal({
  ...
  // Reset checked state whenever modal opens
  useEffect(() => {
    if (open) {
      setSearchQuery("");
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl shadow-2xl p-6 [&>button]:hidden">
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="max-h-60 overflow-y-auto divide-y divide-neutral-100 dark:divide-neutral-800 border border-neutral-100 dark:border-neutral-800 rounded-lg">
