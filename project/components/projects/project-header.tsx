...
export function ProjectHeader({
  ...
  // Combine project owner and members for the Assignee filter dropdown
  ...
  return (
    <div className="flex flex-col gap-2 bg-transparent px-0 py-0 m-0">
      <div className="flex flex-wrap items-center justify-between gap-4 py-1">
        ...
        {/* Right side: Search, Filter, and Three-Dots Menu */}
        <div className="flex items-center space-x-3 ml-auto flex-wrap">
          {/* Search Input - made much longer (w-64 sm:w-80 md:w-96) */}
